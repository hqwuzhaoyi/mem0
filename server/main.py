...
MEM0_EMBEDDER_DIMS = os.environ.get("MEM0_EMBEDDER_DIMS", "")
...
DEFAULT_CONFIG = {
    ...
    "vector_store": {
        ...
        "config": {
            ...
            **({"embedding_model_dims": int(MEM0_EMBEDDER_DIMS)} if MEM0_EMBEDDER_DIMS else {}),
        },
    },
    "llm": {
        "provider": "openai",
    ...
    "embedder": {"provider": "openai", "config": {
        "api_key": OPENAI_API_KEY, "model": DEFAULT_EMBEDDER_MODEL,
        **({"openai_base_url": MEM0_EMBEDDER_BASE_URL} if MEM0_EMBEDDER_BASE_URL else {}),
        **({"embedding_dims": int(MEM0_EMBEDDER_DIMS)} if MEM0_EMBEDDER_DIMS else {}),
    }},
